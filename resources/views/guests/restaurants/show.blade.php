    ...
    <div class="container">
        <div class="row d-flex justify-content-between">
            <div class="col-7 mr-5">
                <div class="row">
                    <div class="col-12 ristorante_info">
                        ...
                        <div class="row pl-2">
                            <div class="col-12 col-sm-12 col-md-6 col-xl-5 p-0  dish" v-for="(dish, index) in dishes"
                                v-if="dish.user_id == {{ $user->id }}">
            ...
            <div class="col-4 position-relative pr-4">
                <div class="row sticky-top carrello">
                    <div class="col-12 cart">
                        <button type="button" class="btn btn-primary btn-block"
                            v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}">Vai alla cassa</button>
                        <button disabled class="btn btn-primary btn-block" v-else>Vai alla cassa</button>
                        <h4 v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}" class="mt-4">Il tuo
                            ordine:</h4>
                        ...
                        <button type="button" class="btn btn-danger btn-block"
                            v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}" @click="emptyCart">Svuota il
                            carrello</button>
